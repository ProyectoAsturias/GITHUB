...
/**
 *Devuelve el nombre y el tipo de los documentos adjuntos que contiene un elemento de una capa
 */
...
function getDocument($idDocument){
	...
	$dbConnection->close();
	//$path="/usr/local/Localgis.MODELO/admcar/class/documentos/".$dir."/".$idDocument;
	$path="C:/Users/JOSE/Desktop/".$dir."/".$idDocument;
	if (file_exists($path)) {
