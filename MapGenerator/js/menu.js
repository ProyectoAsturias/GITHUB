...
function showListMaps() {
	...
	$('.chosen-select').chosen({
		width : "100%",
		search_contains : true,
		placeholder_text_single : "Seleccione un Mapa"
	});
	$.ajax({
		type : "POST",
...
function showListFamilies() {
	...
	$('#selectFamily').chosen({
		width : "100%",
		search_contains : true,
		placeholder_text_single : "Seleccione una Familia"
	});
	$('#selectLayer').chosen({
		width : "100%",
		search_contains : true,
		placeholder_text_single : "Seleccione una Capa"
	});
	$.ajax({
		type : "POST",
		url : apiPath + "apiLocalgis.php",
